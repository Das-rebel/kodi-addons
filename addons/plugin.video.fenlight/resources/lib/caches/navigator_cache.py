...
class NavigatorCache:
	...
	{'name': 'Trending UK Recent', 'mode': 'build_movie_list', 'action': 'trakt_movies_trending_recent_uk', 'random_support': 'true', 'iconImage': 'trending_recent'},
	...
	{'name': 'Trending UK', 'mode': 'build_tvshow_list', 'action': 'trakt_tv_trending_uk', 'random_support': 'true', 'iconImage': 'trending'},
	{'name': 'Trending UK Recent', 'mode': 'build_tvshow_list', 'action': 'trakt_tv_trending_recent_uk', 'random_support': 'true', 'iconImage': 'trending_recent'},
