...
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'fenlight.github.io'},
#==================== Watched Indicators
...
{'setting_id': 'tmdb.read_access_token', 'setting_type': 'string', 'setting_default': 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJiMTRjMjY1NmY3MmU1YmFiMjMzZGVmMzY5MjhhMjAyYiIsIm5iZiI6MTc3NzU3Mzk1Mi41MjMsInN1YiI6IjY5ZjNhMDQwZTUzODE2ODAwY2Y3ZGNmNSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.M7UJoYomkjrlJ4m1jJ7zBUAALt-xL7C4uml5cwJdxBk'},
#==================== MDbList API + Rating Source
{'setting_id': 'mdblist.api_key', 'setting_type': 'string', 'setting_default': ''},
{'setting_id': 'rating_source', 'setting_type': 'string', 'setting_default': 'tmdb'},
{'setting_id': 'rating_source_name', 'setting_type': 'string', 'setting_default': 'TMDb'},
{'setting_id': 'rating_filter.enabled', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'rating_filter.threshold', 'setting_type': 'string', 'setting_default': '7.0'},
{'setting_id': 'rating_filter.show_unrated', 'setting_type': 'boolean', 'setting_default': 'false'},
#==================== TMDb Lists
